...
import com.springData.servicio.ProductoServicio;
...
public class ProductoController {
    ...
    // El controlador se apoya solo en la capa de servicio
    ...
    public String listarProductos(
        ...
        Page<Producto> page = (q != null && !q.isBlank())
                ? productoServicio.buscarPorNombre(q, pageable)
                : productoServicio.listar(pageable);
